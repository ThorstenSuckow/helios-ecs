...
export namespace helios::ecs {
    ...
    public:
        ...
        ecs::Entity<ecs::EntityManager<THandle>> get() {
            ...
            return ecs::Entity<ecs::EntityManager<THandle>>{
                THandle{entityId_, versionId_},
                static_cast<ecs::EntityManager<THandle>*>(entityManager_)
            };
    ...
    public:
        ...
        :   handleId_(ecs::common::types::HandleTypeId::template id<THandle>()),
            entityId_(handle.entityId()),
            versionId_(handle.versionId()),
            entityManager_(static_cast<const void*>(&entityManager))
        {}
        ...
        ecs::Entity<const ecs::EntityManager<THandle>> get() {
            ...
            return ecs::Entity<const ecs::EntityManager<THandle>>{
                THandle{entityId_, versionId_},
                static_cast<const ecs::EntityManager<THandle>*>(entityManager_)
            };
