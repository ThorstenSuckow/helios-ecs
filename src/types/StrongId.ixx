...
export module helios.ecs.types.StrongId;

import helios.ecs.types.FuncDefs;
...
template<typename Tag>
struct std::hash<helios::ecs::types::StrongId<Tag>> {
    helios::ecs::types::StrongId_t operator()(const helios::ecs::types::StrongId<Tag>& id) const noexcept {
        return id.value();
    }
